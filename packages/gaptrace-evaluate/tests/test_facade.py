...
from gaptrace_evaluate import EvalResult, available_metrics, check, evaluate
...
from gaptrace_evaluate.policy.persistence import load_policy as _real_load_policy
from gaptrace_evaluate.policy.persistence import save_policy
...
class TestPolicyOverride:
    ...
    def test_evaluate_skips_load_policy_when_policy_given(self, full_record):
        ...
        with mock.patch("gaptrace_evaluate.facade.load_policy") as mock_load:
            result = evaluate(
                full_record,
    ...
    def test_evaluate_calls_load_policy_when_policy_omitted(self, full_record):
        with mock.patch(
            "gaptrace_evaluate.facade.load_policy", wraps=_real_load_policy
        ) as mock_load:
...
class TestPrimitiveTargets:
    ...
    gaptrace_capture.capture() accepts) must score, not AttributeError."""
...
class TestCacheRiskIntegration:
    ...
    def test_fires_with_no_chunks_when_cache_was_checked(self):
        from gaptrace_core.schema import CacheRecord
...
class TestFilterRiskIntegration:
    ...
    def test_fires_with_no_chunks_when_filter_applied(self):
        from gaptrace_core.schema import FilterRecord
...
class TestScoreMarginCheckFactor:
    ...
    def test_check_flags_thin_margin(self):
        from gaptrace_core.schema import ChunkRecord
