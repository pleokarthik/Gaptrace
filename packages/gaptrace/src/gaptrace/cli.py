...
from gaptrace import store
from gaptrace.explain import loader
from gaptrace.explain.renderer import html as html_renderer
from gaptrace.explain.renderer import terminal as terminal_renderer
...
@click.group()
def main():
    """gaptrace — analyst CLI for the gaptrace observability system."""
