from ragradar_capture.scaffold.template import generate_scaffold
...
class TestGenerateScaffold:
    def test_creates_file(self, tmp_path):
        ...
        assert "ragradar_capture.start" in content
        old_alias = "ragradar" + "run"  # retired import name; concat keeps repo grep clean
        assert old_alias not in content
